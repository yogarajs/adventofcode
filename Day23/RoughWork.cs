...
//{
//    //mapVisited = new bool[map.Length, map[0].Length];
//    //int k = i;
//    //while (k > 1)
//    //{
//    //    var positions = paths[k - 1];
//    //    positions.ForEach(position =>
//    //    {
//    //        mapVisited.SetValue(false, position.x, position.y);
//    //    });
//    //    k--;
//    //}
//    do
...
//        var nextPossiblePositions = GetPossiblePaths2(paths[i].Last(), i).ToList();
//        if (nextPossiblePositions.Count == 0)
//        {
//            //if (paths[i].Last().x == endPosition.x && paths[i].Last().y == endPosition.y)
//            //{
//            //    break;
//            //}
//            //else
...
//                newPath.AddRange(paths[i].Take(previousLastIndex));
//                newPath.Add(nextPossiblePositions[0]);
...
//        else
//        {
//            //nextPossiblePositions.ForEach(np =>
//            //{
//            //    var newPath = new List<(int, int)>();;
...
//        else
//        {
//            var alreadyVisitedCompletedPaths = paths.Where(p => p.Value.Last().x == endPosition.x && p.Value.Last().y == endPosition.y && p.Value.Contains((right.x, right.Item2)))?.ToList();
...
//        else
//        {
//            var alreadyVisitedCompletedPaths = paths.Where(p => p.Value.Last().x == endPosition.x && p.Value.Last().y == endPosition.y && p.Value.Contains((left.x, left.Item2)))?.ToList();
//            if (alreadyVisitedCompletedPaths.Any())
//            {
//                //if (alreadyVisitedCompletedPaths.Count > 0)
//                //{
...
//        else
//        {
//            var alreadyVisitedCompletedPaths = paths.Where(p => p.Value.Last().x == endPosition.x && p.Value.Last().y == endPosition.y && p.Value.Contains((bottom.Item1, bottom.y)))?.ToList();
//            if (alreadyVisitedCompletedPaths.Any())
//            {
//                //if (alreadyVisitedCompletedPaths.Count > 0)
//                //{
...
//        else
//        {
//            var alreadyVisitedCompletedPaths = paths.Where(p => p.Value.Last().x == endPosition.x && p.Value.Last().y == endPosition.y && p.Value.Contains((top.Item1, top.y)))?.ToList();
//            if (alreadyVisitedCompletedPaths.Any())
//            {
//                //if (alreadyVisitedCompletedPaths.Count > 0)
//                //{
...
//Console.WriteLine($"Part1: {longestPath}");